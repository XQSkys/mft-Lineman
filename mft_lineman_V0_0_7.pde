...
int i=0;
       ...
       strokeWeight(8);          
        ...
        dy = sin(winkel)* laenge; 
          dz = tan(winkel)* laenge; 
              stroke(50,dx+laenge-iz+150    ,0,200);
  ...
  while ( iy < by) { 
       ...
       strokeWeight(8);          
        ...
        //stroke(0,0,dx+laenge);
        translate(iz,100,50+cos(winkel)*50);
       line(500, 150,200, dz/laenge, 2*dx/laenge+150, dx*laenge);
