...
public class mft_lineman_Vx0_1_2_interhunter_androidtest extends PApplet {
  ...
  int abeany=0;
    ...
    float amx2=0;
     float amy2=0;
       ...
       int aship1=color(200,0,0);
     int aship2 =color(0,0,200);
      int ashipx1=color(200,0,0);
     int ashipx2 =color(0,0,200);
     int ashipm=color(0,0,200);
...
asap=0;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "mft_lineman_Vx0_1_2_interhunter_androidtest" };
    if (passedArgs != null) {
